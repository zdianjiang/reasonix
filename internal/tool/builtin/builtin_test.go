...
func TestBuiltinsRegistered(t *testing.T) {
	want := []string{"bash", "code_index", "edit_file", "glob", "grep", "ls", "message_send_file", "message_send_image", "move_file", "multi_edit", "read_file", "web_fetch", "write_file"}
...
func TestBuiltinReadOnlyClassification(t *testing.T) {
	readOnly := map[string]bool{
		"read_file": true, "ls": true, "glob": true, "grep": true, "code_index": true, "message_send_file": true, "message_send_image": true, "web_fetch": true,
